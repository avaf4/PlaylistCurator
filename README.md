...
**Walkthrough video:** [Music Playlist Explorer Walkthrough](https://www.loom.com/share/30ffc59e51094740a18d4c8036cbfdee)

### Reflection

* Did the topics discussed in your labs prepare you to complete the assignment? Be specific, which features in your weekly assignment did you feel unprepared to complete?

Yes, the topics from lab helped lead up to the creation of the final web app. The only tricky aspect for me was dealing with API keys since there are outside aspects that need to be considered for the API to work properly.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
If I had more time, I would add a search featurr, add a song queue and allow playable playlists, add a list of preset images to choose from for custom playlist thumbnails, and add a liked songs playlist.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

For my project demo, I was able to present all necessary aspects of my project within the timeframe and used language that the audience could properly understand. Next time, I will spend more time overviewing my code and explaining how the codebase ties into the produced output of the website.


### Shout out

Shout-out to Zainab, Doris, Danny, Devarsh, Daniel, and David!